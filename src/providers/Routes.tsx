    ...
    <Router>
      <Switch>
        ...
        <ProtectedRoute
          ...
          Component={routes.employee.component}
        />
        <ProtectedRoute
          roles={[SuperAdmin]}
          exact
          path={routes.company.path}
          Component={routes.company.component}
        />
        <ProtectedRoute
          roles={[SuperAdmin]}
          exact
        ...
        <BaseRoute
          ...
          component={routes.passwordChange.component}
        />
        <BaseRoute
          exact
          path={routes.acceptInvitation.path}
          component={routes.acceptInvitation.component}
        />
        <ProtectedRoute
          exact
